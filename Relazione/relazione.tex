...
\begin{document}
	...
	\end{figure}\\
	Per questioni di spazio, ma volendo comunque approfondire il diagramma soprariportato, si approfondiscono le seguenti scelte progettuali:
	\begin{itemize}
		...
		\item l'entità \texttt{Utente} presenta un campo Password criptato...;
	...
	\begin{itemize}
		...
		\item password dell'amministratore salvata con tecnica di criptazione...;
