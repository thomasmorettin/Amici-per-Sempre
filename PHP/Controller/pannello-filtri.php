...
function renderPannelloFiltri(?string $action, array $filtri = []): string
{
    ...
    $html = '
            <div class="filter-panel" id="side-panel" inert>
                <div class="filter-content">
                    <form method="GET" action="' . htmlspecialchars($action, ENT_QUOTES) . '" id="form-filtri">
                        <div class="azioni-filtro">
                            <button type="submit" id="applica" data-n-filtri="' . $filtri_cambiati .'" title="Applica filtri">Applica ' . $filtri_cambiati . ' filtri</button>
                            <button type="button" class="reset" aria-label="Azzera i filtri" title="Azzera i filtri">
        ...
        $html .= '         
                        <div class="accordion">
                            <div class="accordion-header">
                                ...
                                <button type="button" class="header" aria-expanded="false" id="legenda-tipo-animale" aria-describedby="count-tipo-animale" title="Tipo animale">
                                    Tipo animale
                                    <svg aria-hidden="true">
    ...
    if (in_array('Dati animale', $sections, true)) {
        $html .= '           
                        <div class="accordion">
                            <div class="accordion-header">
                                <div class="legend-left"></div>
                                <button type="button" class="header" aria-expanded="false" aria-describedby="count-dati-animale" title="Dati animale">
                                Dati animale
                                <svg aria-hidden="true">
                                    <use href="{{root}}/Resources/icons.svg#arrow"></use>
                                </svg>
    ...
    if (in_array('Dati persona', $sections, true)) {
        $html .= '             
                        <div class="accordion">
                            <div class="accordion-header">
                                <div class="legend-left"></div>
                                <button type="button" class="header" aria-expanded="false" aria-describedby="count-dati-persona" title="Dati persona">
                                    Dati persona
                                    <svg aria-hidden="true">
                                        <use href="{{root}}/Resources/icons.svg#arrow"></use>
                                    </svg>
    ...
    if (in_array('Razze', $sections, true)) {
        ...
        foreach ($razze["Cane"] as $razza_cane) {
            ...
            $razze_cane_html .= '       
                        <label for="' . $razza_cane_id . '">
                            ...
                            <svg aria-hidden="true">
                                <use href="{{root}}/Resources/icons.svg#circle"></use>
                            </svg>
                        </label>';
        }
        ...
        $html .= '          
                        <div class="accordion">
                            <div class="accordion-header">
                                <div class="legend-left"></div>
                                <button type="button" class="header" aria-expanded="false" id="legenda-razze-cane" aria-describedby="count-razze-cane" title="Razze cane">
                                    Razze cane
                                    <svg aria-hidden="true">
                                        <use href="{{root}}/Resources/icons.svg#arrow"></use>
                                    </svg>
                        ...
                        <div class="accordion">
                            <div class="accordion-header">
                                <div class="legend-left"></div>
                                <button type="button" class="header" aria-expanded="false" id="legenda-razze-gatto" aria-describedby="count-razze-gatto" title="Razze gatto">
                                    Razze gatto
                                    <svg aria-hidden="true">
                                        <use href="{{root}}/Resources/icons.svg#arrow"></use>
                                    </svg>
